...
//        let songItems = paths.flatMap({ return Song(path: $0) })
    ...
    override open func viewDidLoad() {
        super.viewDidLoad()
        library.append(Song(path: "阿里郎-隔壁泰山", type: "mp3")!)
        
        library.append(Song(path: "李贰叁-往后余生", type: "mp3")!)
        library.append(Song(path: "薛之谦-丑八怪", type: "mp3")!)
    ...
    fileprivate func updateForColors(_ colors: UIImageColors?) {
        ...
        leftChannelColor = UIColor.blue
        rightChannelColor = UIColor.red
